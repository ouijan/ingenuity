...
func generateTiledCode(project *TiledProject, outputPath string) error {
	...
	file.PackageComment("Code generated by Ingenuity Tiled Codegen. DO NOT EDIT.")
	...
	if err != nil {
		core.Log.Error(fmt.Sprintf("Error creating directory: %s", outputPath))
	}

	core.Log.Debug(fmt.Sprintf("%#v", file))
